...
class ConfigurationTest extends AbstractTestCase
{
    ...
    public function testDefaultConfiguration(): void
    {
        ...
        $this->assertEquals(['_profiler/*', '_wdt/*', 'api/health', 'api/ping'], $config['path_filters']['exclude']);
        $this->assertEquals(
    ...
    public function testPartialConfiguration(): void
    {
        ...
        $this->assertEquals(['_profiler/*', '_wdt/*', 'api/health', 'api/ping'], $config['path_filters']['exclude']); // default
    }

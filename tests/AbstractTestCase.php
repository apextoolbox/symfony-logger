...
class TestKernel extends Kernel
{
    ...
    public function registerContainerConfiguration(LoaderInterface $loader): void
    {
        $loader->load(function (ContainerBuilder $container) {
            $container->loadFromExtension('apex_toolbox_logger', $this->configs);
            
            // Set test configuration
            $container->setParameter('apex_toolbox_logger.token', 'test-token');
            $container->setParameter('apex_toolbox_logger.enabled', true);
        });
    }

    public function getCacheDir(): string
    {
        return sys_get_temp_dir() . '/apex_toolbox_logger_test';
    }
